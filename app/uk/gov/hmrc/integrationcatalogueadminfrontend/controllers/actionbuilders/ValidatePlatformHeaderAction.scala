...
@Singleton
class ValidatePlatformHeaderAction @Inject()(appConfig: AppConfig)(implicit ec: ExecutionContext)
  ...
  private def validatePlatformType(platform: String) ={
    PlatformType.values.map(_.toString()).contains(platform.toUpperCase)
  }
}
